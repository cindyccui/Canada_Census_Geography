# seperates csv table into csv tables by utm zone based on fields
...
for zone in utm_zone_list:
	utm_nad27_epsg = 26700 + int(zone) #nad27 datum
	writer = csv.writer(open("csv_by_utm_zone/utm" + str(utm_nad27_epsg) + ".csv", 'a'),lineterminator = '\n')
